...
<title><?php the_tag_title()?> | Centrale à Béton &amp; Usines  de Concassage et de Criblage </title>
...
<h1 class="featured-title-heading"><?php the_tag_title()?></h1>
</div>
<div id="breadcrumbs">
...
<center>
<?php the_tag_description();?></center>
...
<li><img src="<?php the_thumbnail()?>" alt="<?php the_subtitle()?>" class="img-responsive"></li>
