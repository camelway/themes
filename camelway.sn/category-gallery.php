...
<center>
Nous annonçons régulièrement nos nouvelles offres, expéditions et installations d'usines et ressentons le bonheur de partager nos réalisations avec nos clients.</center>
...
<li><a href="<?php the_permalink();?>"><img src="<?php the_thumbnail()?>" alt="<?php echo $imgs[0]->title;?>" class="img-responsive"></a></li>
...
</div></div>            <div class="col-md-12">                <div id="Product Info" class="tabcontent" style="display: block;">
