...
?>
            <li itemprop="itemListElement" itemscope itemtype="https://schema.org/Product">
                ...
                <div class="thumbnail">
                    <a href="<?php the_permalink()?>"><img src="<?php the_thumbnail()?>" alt="<?php the_title()?>" itemprop="image"></a>
                </div>
                <div class="description">
                    <h2 itemprop="name"><a href="<?php the_permalink()?>" title="<?php the_subtitle();?>"><?php the_subtitle()?></a></h2>
                    <p itemprop="description"><?php echo dm_trim_words(get_the_excerpt(), 350);?></p>
                    <a href="<?php the_permalink()?>#headline" class="more" itemprop="url">Learn More</a>
                    <a href="<?php the_permalink()?>#feedback" class="inquiry">Get Quote</a>
                </div>
                <div itemprop="offers" itemscope itemtype="https://schema.org/AggregateOffer">
                   ...
                   <div itemprop="seller" itemscope itemtype="http://schema.org/Organization">
                       <meta itemprop="name" content="Camelway Philippines">
                   </div>
                </div>
