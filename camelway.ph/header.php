...
<div class="container top">
    ...
    <div class="introduce">
        <p>CAMELWAY : Top Concrete Batching Plant Manufacturers <a href="<?php the_permalink(1);?>">More &gt;&gt;</a></p>
    </div>
</div>
<div class="container head">
    <a href="<?php dminfo('home');?>" class="logo"><img src="<?php dminfo('template_url')?>images/logo.png" alt="Camelway"></a>
    <div class="top-contact">
        <p class="mobile">+8615617971467</p>
        <p class="email">camelwaych@gmail.com</p>
    </div>
</div>
<div class="container menu">
    <ul>
        ...
        <li><a href="<?php the_permalink(3);?>">Contact US</a></li>
