...
<div class="container">
   ...
   <div class="btn"><img src="https://www.camelway.ph/dm-content/themes/hi-domai/images/mess.png" alt="Message" title="Message"><span>Message</span></div>
   <div class="choiceWindow">
            <lable class="x">x</lable>
            <form action="https://www.camelway.ph/dm-feedback.php" method="post" class="STYLE-NAME" onsubmit="return ajax_submit(this);">
                <h3>Request a Fast & Free Quote</h3>
                <p class="mess_pop">Get a Quote Directly from the Manufacturer.</p>
                <p>
                <input type="text" name="user_name" placeholder="Name:(required)" required="">
                </p>
                <p>
                <input type="text" name="user_mobile" placeholder="Phone:(required)" required="">
                <p>
                <input type="text" name="user_email" placeholder="Email:">
                </p>
                <p>
                <input type="text" name="content" placeholder="Inquiry: product, capacity, delivery port, etc.(required)" required="">
                </p>
                <p><input type="submit" value="submit" /></p>
            </form>
        </div>
</div>
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-75819314-13"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'UA-75819314-13');
    ...
    (function(){
        if(!supportwebp){
            ...
            for(var i in images){
                ...
                if(originsrc && originsrc.substr(-5) == '.webp' && ( originsrc.substr(0, 27) == 'https://www.camelway.ph/' || originsrc.substr(0,1) == '/')){
                    images[i].src = 'https://www.camelway.ph/dm-ajax.php?action=webp2jpg&f='+encodeURIComponent(originsrc);
                }
            }
        }
...
<?php } ?>
        ...
        wabox.addEventListener('click', function(){
            ...
            gtag('event', 'openwhatsapp', {'send_to': 'UA-75819314-13', 'event_category': 'click whatsapp', 'event_label': 'open ' + waid + ' in '+escape(window.location.href)});
        });
        document.body.appendChild(wabox);
    })();

</script>
<script src="/dm-content/themes/hi-domai/jquery-3.4.1.min.js"></script>
<script>
