...
<?php }
$ps = get_posts(array('category__in'=>array(1,2,4,6,8), 'posts_per_page'=>5, 'meta_key'=>'viewed', 'orderby'=>'meta_value_num'));
foreach($ps as $p){ ?>
...
<?php } ?>
        ...
        <div class="foot-contact">
            <div class="tel">
                <p class="key">008618838109566</p>
                <p class="tips">24-hour customer service hotline</p>
            </div>
            <div class="email">
                <p class="key">info@camelway.com</p>
