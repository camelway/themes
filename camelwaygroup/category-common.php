...
?>
            <li>
                <div class="thumbnail"><a href="<?php the_permalink()?>"><img src="<?php dminfo('ajax_url')?>?action=cropimage&f=<?php the_thumbnail()?>&width=350" alt="<?php the_subtitle();?>" width="500" height="262"></a></div>
