<div class="side-rfq">
    ...
    <form action="<?php dminfo('feedback_url')?>" method="post" class="feedback-form" onsubmit="return async_submit(this)">
        ...
        <p class="input full-row"><input name="user_mobile" type="text" placeholder="Mobile:"></p>
        <p class="input full-row"><input name="user_email" type="email" placeholder="Email:"></p>
        <p class="input full-row"><textarea name="content" placeholder="Product name, detail requirements, etc*" rows="2"></textarea></p>
