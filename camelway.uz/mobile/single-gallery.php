...
while(have_images('gallery')){
    the_image();
    $img = empty(get_the_image_thumbnail()) ? get_the_image_link() : get_the_image_thumbnail();
?>
            <a href="<?php the_image_link()?>">
                <amp-img src="<?php echo $img;?>" layout="responsive" width="600" height="350" alt="<?php the_image_title()?>"><?php echo webpfallback($img, get_the_subtitle(), 600, 350)?></amp-img>
...
?>
        <li>
            ...
            <p class="price"><?php echo show_1_mobile(get_the_data('mobile'))?> </p>
        </li>
