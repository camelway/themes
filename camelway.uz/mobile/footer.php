<footer class="wrap">
    &copy;<?php echo date('Y')?> ИП ООО «CAMELWAY CHINA» <div class="links"><a href="https://www.camelway.uz/byetohhiye-zavodi/">Бетонные заводы</a></a>
</footer>
<amp-analytics type="gtag" data-credentials="include">
<script type="application/json">{
    "vars": {
        "gtag_id": "UA-75819314-8",
        "config" : {
...
<script type="application/json">{
    ...
    "vars": {
        "googleConversionId": "AW-663867645/ER-nCJPG9cUBEP2hx7wC",
