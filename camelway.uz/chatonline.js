(function(baseurl){
    ...
    wabox.addEventListener('click', function(){
        ...
        gtag('event', 'opentelegram', {'send_to': 'UA-75819314-8', 'event_category': 'click telegram', 'event_label': 'open ' + waid + ' in '+escape(window.location.href)});
    });
    document.body.appendChild(wabox);

    //var telegrams = ['camelwaydennis', 'camelwayCHAO'];
    var telegrams = ['camelwaydennis'];
