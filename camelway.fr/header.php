...
<div class="container top">
    ...
    <div class="introduce">
        <p>Camelway conçoit et fabrique des machines à béton depuis 1983. <a href="<?php the_permalink(41);?>">More &gt;&gt;</a></p>
    </div>
</div>
<div class="container head">
    <a href="<?php dminfo('home');?>" class="logo"><img src="<?php dminfo('template_url')?>images/logo.png" alt="Camelway"></a>
    <div class="top-contact">
        <p class="mobile">+8618838109566</p>
        <p class="email">sales@camelway.fr, vip@camelway.com</p>
    </div>
</div>
<div class="container menu">
    <ul>
        <li><a href="<?php dminfo('home')?>">Accueil</a></li>
        <li><a href="<?php the_permalink(41);?>">À propos de nous</a></li>
        <li><a href="<?php the_permalink(42);?>">Nous contacter</a></li>
        ...
        <li class="right"><a href="<?php the_permalink(1);?>">Produits</a>
            <i class="indicator"></i>
            <ul>
