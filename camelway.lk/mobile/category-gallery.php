...
?>
    <div class="category-entry">
        ...
        <a href="<?php the_mobile_permalink()?>"><amp-img src="<?php the_post_data('banner')?>" layout="responsive" width="780" height="270" alt="<?php the_title()?>"><?php echo webpfallback(get_the_thumbnail(), get_the_subtitle(), 600, 350)?>
</amp-img></a>
...
?>
        <li>
            <a href="<?php the_mobile_permalink()?>"><amp-img src="<?php the_thumbnail()?>" alt="<?php the_title()?>" layout="responsive" width="600" height="350"><?php echo webpfallback(get_the_thumbnail(), get_the_subtitle(), 600, 350)?>
</amp-img></a>
