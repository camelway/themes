...
<div class="container single-header">
    ...
    <amp-img src="<?php the_thumbnail()?>" layout="responsive" width="600" height="350" alt="<?php the_subtitle?>"><?php echo webpfallback(get_the_thumbnail(), get_the_subtitle(), 600, 350)?>
</amp-img>
...
?>
        <a href="<?php the_image_link()?>"><amp-img src="<?php echo $img;?>" alt="<?php the_image_title()?>" layout="responsive" width="600" height="350px"><?php echo webpfallback($img, get_the_subtitle(), 600, 350)?>
</amp-img></a>
<?php } ?>
</div>
<?php } ?>
...
?>
        <li>
            <a href="<?php the_mobile_permalink()?>" class="thumbnail"><amp-img src="<?php the_thumbnail()?>" layout="responsive" width="600" height="350" alt="<?php the_subtitle()?>"><?php echo webpfallback(get_the_thumbnail(), get_the_subtitle(), 600, 350)?>
</amp-img></a>
