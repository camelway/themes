(function(baseurl){
    ...
    wabox.addEventListener('click', function(){
        window.open(walink); 
        gtag('event', 'conversion', {'send_to': 'AW-801325996/bWK2CPSn9c4BEKyHjf4C'});
        gtag('event', 'openwhatsapp', {'send_to': 'UA-75819314-15', 'event_category': 'click whatsapp', 'event_label': 'open ' + waid + ' in '+escape(window.location.href)});
    });
    document.body.appendChild(wabox);
    /*
    var telegrams = ['camelway', 'Bemonmachinery01'];
