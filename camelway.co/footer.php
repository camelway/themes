    ...
    (function(){
        if(!supportwebp){
            ...
            for(var i in images){
                ...
                if(originsrc && originsrc.substr(-5) == '.webp' && ( originsrc.substr(0, 24) == 'https://www.camelway.co/' || originsrc.substr(0,1) == '/')){
                    images[i].src = 'https://www.camelway.co/dm-ajax.php?action=webp2jpg&f='+encodeURIComponent(originsrc);
                }
            }
        }
<?php if(is_single()){ ?>
