...
<div class="container top">
    ...
    <div class="introduce">
        <p>Camelway ha estado trabajando en el mercado de plantas de concreto por más de 30 años desde 1983. <a href="<?php the_permalink(1);?>">More &gt;&gt;</a></p>
    </div>
</div>
<div class="container head">
    <a href="<?php dminfo('home');?>" class="logo"><img src="<?php dminfo('template_url')?>images/logo.png" alt="Camelway"></a>
    <div class="top-contact">
        <p class="mobile">+8618838109566, +8618639554260</p>
        <p class="email">vip@camelway.com, sales@camelway.co</p>
    </div>
</div>
<div class="container menu">
    <ul>
        <li><a href="<?php dminfo('home')?>">Inicio</a></li>
        <li><a href="<?php the_permalink(58);?>">Sobre Nosotros</a></li>
        <li><a href="<?php the_permalink(59);?>">Contáctenos</a></li>
        ...
        <li class="right"><a href="<?php the_permalink(1);?>">Productos</a>
            <i class="indicator"></i>
            <ul>
