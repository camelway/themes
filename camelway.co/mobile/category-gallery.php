...
?>
    <div class="category-entry">
        ...
        <a href="<?php the_mobile_permalink()?>"><amp-img src="<?php the_post_data('banner')?>" layout="responsive" width="780" height="270" alt="<?php the_title()?>"><?php echo webpfallback(get_the_thumbnail(), get_the_subtitle(), 780, 270)?></amp-img></a>
