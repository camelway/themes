...
<div class="container single">
    <div class="main">
        ...
        <div class="introduction">
            <img src="<?php the_thumbnail()?>" alt="<?php the_subtitle()?>" class="thumbnail" width="600" height="350">
            <div class="text">
...
while(have_images('gallery')){
    the_image();
?>
            <a href="<?php the_image_link()?>" target="_blank" title="<?php the_image_title();?>"><img src="<?php if(get_the_image_thumbnail() != '') { the_image_thumbnail();}else{ the_image_link(); }?>" alt="<?php the_image_title();?>" data-description="<?php the_image_description();?>" width="600" height="350"></a>
<?php } ?>
        </div>
        <div class="content">
<?php the_content();?>
