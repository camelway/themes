...
<?php } if(is_home()){?>
    <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"<?php echo home_url(1)?>#organization","name":"Camelway Africa","url":"<?php echo home_url(1)?>","sameAs":["https://www.camelway.com/","https://www.facebook.com/camelway/"],"logo":{"@type":"ImageObject","@id":"<?php echo home_url(1)?>#logo","inLanguage":"en-US","url":"https://data.camelway.net/static/images/camelway-500x500.png","width":500,"height":500,"caption":"Camewlay Africa Logo"},"image":{"@id":"<?php echo home_url(1)?>#logo"}},{"@type":"WebSite","@id":"<?php echo home_url(1)?>#website","url":"<?php echo home_url(1)?>","name":"Camelway Africa","inLanguage":"en-US","description":"sell construction machine and provide construction machine information in africa","publisher":{"@id":"<?php echo home_url(1)?>#organization"},"potentialAction":[{"@type":"SearchAction","target":"<?php echo home_url(1)?>?s={search_term_string}","query-input":"required name=search_term_string"}]},{"@type":"WebPage","@id":"<?php echo home_url(1)?>#webpage","url":"<?php echo home_url(1)?>","name":"Camelway Africa | Concrete Batching Plant | Asphalt Mixing Plant| Stone Crushing Plant | Block Making Plant | Concrete Mixer | Concrete Pump | Rebar Equipment","isPartOf":{"@id":"<?php echo home_url(1)?>#website"},"inLanguage":"en-US","about":{"@id":"<?php echo home_url(1)?>#organization"},"datePublished":"<?php the_time('Y-m-d h:i:sP', 1);?>","dateModified":"<?php the_modified_time('Y-m-d h:i:sP')?>","description":"provide construction machine sale information in africa include batching plant, asphalt plant, crushing plant, concrete mixer, cocnrete pump, rebar equipment, etc","potentialAction":[{"@type":"ReadAction","target":["<?php echo home_url(1)?>"]}]}]}</script>
