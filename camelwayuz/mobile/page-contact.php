...
?>
        <li>
            <div class="avatar">
                <amp-img layout="intrinsic" src="<?php echo $user->get_meta('avatar')?>" alt="<?php echo $user->display_name;?>" width="100" height="100"><?php webpfallback($user->get_meta('avatar'), $user->display_name, 100, 100);?></amp-img>
            </div>
            <div class="info">
