...
<div class="wrap about-content">
    <div class="container entry-content">
        <amp-img layout="intrinsic" width="600" height="350" src="<?php the_thumbnail()?>" alt="<?php the_subtitle()?>" class="thumbnail"><?php webpfallback(get_the_thumbnail(), get_the_subtitle(), 600, 350);?></amp-img>
        <?php the_content();?>
    </div>
</div>
