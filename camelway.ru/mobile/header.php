...
<?php } ?>
    <meta property="og:site_name" content="Camelway Россия">
...
<?php } if(is_home()){?>
    <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"<?php echo home_url(1)?>#organization","name":"Camelway Россия","url":"<?php echo home_url(1)?>","sameAs":["https://ru.camelway.com/","https://www.facebook.com/camelway/"],"logo":{"@type":"ImageObject","@id":"<?php echo home_url(1)?>#logo","inLanguage":"ru","url":"https://data.camelway.net/static/images/camelway-500x500.png","width":500,"height":500,"caption":"Camelway Россия Logo"},"image":{"@id":"<?php echo home_url(1)?>#logo"}},{"@type":"WebSite","@id":"<?php echo home_url(1)?>#website","url":"<?php echo home_url(1)?>","name":"Camelway Россия","inLanguage":"ru","description":"<?php dm_description();?>","publisher":{"@id":"<?php echo home_url(1)?>#organization"},"potentialAction":[{"@type":"SearchAction","target":"<?php echo home_url(1)?>?s={search_term_string}","query-input":"required name=search_term_string"}]},{"@type":"WebPage","@id":"<?php echo home_url(1)?>#webpage","url":"<?php echo home_url(1)?>","name":"Camelway Россия | Бетонный завод | Асфальтовый завод| Камнедробильный завод | Завод строительных блоков | Бетономешалка | Бетононасос | Арматурное оборудование","isPartOf":{"@id":"<?php echo home_url(1)?>#website"},"inLanguage":"ru","about":{"@id":"<?php echo home_url(1)?>#organization"},"datePublished":"<?php the_time('Y-m-d h:i:sP', 1);?>","dateModified":"<?php the_modified_time('Y-m-d h:i:sP')?>","description":"<?php dm_description();?>","potentialAction":[{"@type":"ReadAction","target":["<?php echo home_url(1)?>"]}]}]}</script>
<?php }elseif(is_category()){?>
    <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"<?php echo home_url(1)?>#organization","name":"Camelway Россия","url":"<?php echo home_url(1)?>","sameAs":["https://ru.camelway.com/","https://www.facebook.com/camelway/"],"logo":{"@type":"ImageObject","@id":"<?php echo home_url(1)?>#logo","inLanguage":"ru","url":"https://data.camelway.net/static/images/camelway-500x500.png","width":500,"height":500,"caption":"Camewlay Africa Logo"},"image":{"@id":"<?php echo home_url(1)?>#logo"}},{"@type":"WebSite","@id":"<?php echo home_url(1)?>#website","url":"<?php echo home_url(1)?>","name":"Camelway Россия","inLanguage":"ru","description":"ИП ООО «CAMELWAY» продает бетонные заводы, бетономешалки, оборудование для производства бетонных шлакоблоков и различные строительные машины в Россия и страны СНГ","publisher":{"@id":"<?php echo home_url(1)?>#organization"},"potentialAction":[{"@type":"SearchAction","target":"<?php echo home_url(1)?>?s={search_term_string}","query-input":"required name=search_term_string"}]},{"@type":"CollectionPage","@id":"<?php the_category_link()?>#webpage","url":"<?php  the_category_link()?>","name":"<?php the_category_name()?>","isPartOf":{"@id":"<?php echo home_url(1)?>#website"},"inLanguage":"ru","description":"<?php dm_description(180)?>..."}]}</script>
<?php }elseif(is_single() && in_category(array(1,2,3,4,5,6,7))) { ?>
    <script type="application/ld+json">{"@context":"https://schema.org/","@type":"Product","name":"<?php the_subtitle()?>","image":[<?php $images = get_post_images('gallery'); $tmp = '"'.get_the_thumbnail().'",';foreach($images as $image){ $tmp .= sprintf('"%s",', $image->url);} echo trim($tmp, ',')?>],"description":"<?php echo dm_trim_words(get_the_excerpt(), 200);?>","sku":"p-<?php the_ID()?>","mpn":"<?php echo the_category_slug().'-'.get_the_ID();?>","brand":{"@type":"Brand","name":"Camelway"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"<?php the_ratingValue();?>","reviewCount":"<?php the_reviewCount();?>","bestRating":"5","worstRating":"1"},"offers":{"@type":"AggregateOffer","url":"<?php the_permalink()?>#feedback","priceCurrency":"USD","availability":"https://schema.org/PreOrder","itemCondition":"http://schema.org/NewCondition","lowPrice":"<?php the_post_data('lowprice')?>","highPrice":"<?php the_post_data('highprice')?>","seller":{"@type":"Organization","name":"Camelway Россия"}}}</script>
<?php }elseif(is_single() && in_category(array(8,9))){?>
    <script type="application/ld+json">{"@context": "http://schema.org","@type": "BlogPosting","headline": "<?php the_title()?>","alternativeHeadline":"<?php the_subtitle()?>","datePublished": "<?php the_time('Y-m-d');?>","dateModified": "<?php the_modified_time('Y-m-d');?>","image":[<?php $images = get_post_images('gallery'); $tmp = '"'.get_the_thumbnail().'",';foreach($images as $image){ $tmp .= sprintf('"%s",', $image->url);} echo trim($tmp, ',')?>],"keywords":[<?php echo trim(get_the_tag_list('"','", "','"'),',')?>],"mainEntityOfPage":"<?php the_permalink();?>","description":"<?php echo dm_trim_words(get_the_excerpt(), 160)?>","author": "<?php the_author()?>","publisher":{"@type": "Organization","name": "Camelway Россия","url": "https://www.camelway.ru","logo": {"@type": "ImageObject","url": "https://data.camelway.net/static/images/camelway-114x114.png","width":"114","height":"114"}}}</script>
<?php } ?>
...
<header class="wrap">
    ...
    <div class="menu">
        <ul>
            <li><a href="<?php the_mobile_permalink(1)?>">О нас</a></li>
            <li><a href="<?php the_mobile_permalink(2)?>">Свяжитесь с нами</a></li>
