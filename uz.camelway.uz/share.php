<div class="sharebox">
    <a _href="https://yandex.ru/collections/share/?url=<?php echo rawurlencode(dm_url(false))?>&description=<?php echo rawurlencode(get_the_subtitle());?>" title="Яндекс.Коллекции" rel="nofollow" class="favorites"></a>
    ...
    <a _href="https://vk.com/share.php?url=<?php echo rawurlencode(dm_url(false))?>&title=<?php echo rawurlencode(get_the_subtitle())?>" title="ВКонтакте" rel="nofollow" class="vk"></a>
