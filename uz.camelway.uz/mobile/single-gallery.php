...
?>
            <a href="<?php the_image_link()?>">
                <amp-img src="<?php echo $img;?>" layout="responsive" width="600" height="350" alt="<?php the_image_title()?>"><?php echo webpfallback($img, get_the_image_title(), 600, 350)?></amp-img>
