    ...
    (function(){
        if(!supportwebp){
            ...
            for(var i in images){
                ...
                if(originsrc && originsrc.substr(-5) == '.webp' && ( originsrc.substr(0, 23) == 'https://uz.camelway.uz/' || originsrc.substr(0,1) == '/')){
                    images[i].src = 'https://uz.camelway.uz/dm-ajax.php?action=webp2jpg&f='+encodeURIComponent(originsrc);
                }
            }
        }
<?php if(is_single()){ ?>
