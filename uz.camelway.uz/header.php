...
<div class="container top">
    ...
    <div class="introduce">
        <p>Camelway beton zavodlari bozorida 1983 yildan beri 30 yildan ortiq vaqt davomida ishlab kelmoqda. <a href="<?php the_permalink(1);?>">Ko'proq &gt;&gt;</a></p>
    </div>
</div>
<div class="container head">
    ...
    <div class="top-contact">
        ...
        <p class="email">sales@camelway.uz, vip@camelway.com</p>
    </div>
</div>
<div class="container menu">
    <ul>
        <li><a href="<?php dminfo('home')?>">Bosh sahifa</a></li>
        ...
        <li class="right"><a href="<?php the_permalink(1);?>">Mahsulotlar</a>
            <i class="indicator"></i>
            <ul>
