...
$top = new DM_Query('cat='.$category->cat_ID.'&posts_per_page=10&has_thumbnail=1&no_found_rows=1');
if($top->have_posts()){
    $top->the_post();
?>
        <div class="first">
            ...
            <a href="<?php the_permalink();?>" class="headimg"><img src="<?php the_post_data('banner')?>" alt="<?php the_title();?>"></a>
