        ...
        <div class="introduction">
            ...
            <div class="text">
                ...
                <div class="quote-quick share">
                    <a href="#feedback" class="quote-btn">Solicitud de cotización</a>
...
while(have_images('gallery')){
    the_image();
?>
            <img src="<?php the_image_link()?>" alt="<?php the_image_title();?>" title="<?php the_image_title();?>" data-description="<?php the_image_description();?>">
<?php } ?>
        </div>
        <div class="content">
<?php the_content();?>
