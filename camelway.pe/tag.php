...
<?php } ?>
                ...
                <p><?php echo dm_trim_words(get_the_excerpt(), 400)?> <a href="<?php the_permalink();?>" class="more">Más</a></p>
            </li>
<?php }?>
            </ul>
        </div>
...
<?php }else{ ?>
        <div class="no-result">No se ha encontrado ningún objeto, intente buscar lo que quiera.</div>
<?php }?>
