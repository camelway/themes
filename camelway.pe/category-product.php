...
?>
            <li>
                <div class="thumbnail">
                    <a href="<?php the_permalink()?>"><img src="<?php the_thumbnail()?>" alt="<?php the_title()?>"></a>
                </div>
                <div class="description">
                    ...
                    <a href="<?php the_permalink()?>" class="more">Aprende más</a>
                    <a href="<?php the_permalink()?>#feedback" class="inquiry">Solicitud de precio</a>
                </div>
            </li>
<?php } ?>
            </ul>
