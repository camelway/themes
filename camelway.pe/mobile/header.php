...
<?php } ?>
    <meta property="og:site_name" content="Camelway América del sur">
...
<?php } if(is_home()){?>
    <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"<?php echo home_url(1)?>#organization","name":"Camelway América del sur","url":"<?php echo home_url(1)?>","sameAs":["https://www.camelway.com/","https://www.facebook.com/camelway/"],"logo":{"@type":"ImageObject","@id":"<?php echo home_url(1)?>#logo","inLanguage":"en-US","url":"https://data.camelway.net/static/images/camelway-500x500.png","width":500,"height":500,"caption":"Camewlay Africa Logo"},"image":{"@id":"<?php echo home_url(1)?>#logo"}},{"@type":"WebSite","@id":"<?php echo home_url(1)?>#website","url":"<?php echo home_url(1)?>","name":"Camelway Africa","inLanguage":"en-US","description":"vender máquinas de construcción y proporcionar información sobre las máquinas de construcción en América del sur","publisher":{"@id":"<?php echo home_url(1)?>#organization"},"potentialAction":[{"@type":"SearchAction","target":"<?php echo home_url(1)?>?s={search_term_string}","query-input":"required name=search_term_string"}]},{"@type":"WebPage","@id":"<?php echo home_url(1)?>#webpage","url":"<?php echo home_url(1)?>","name":"Camelway América del sur | Planta de hormigón por lotes | Planta de mezcla de asfalto | Planta de trituración de piedra | Planta de fabricación de bloques | Mezclador de hormigón | Bomba de hormigón | Equipo de barras de refuerzo","isPartOf":{"@id":"<?php echo home_url(1)?>#website"},"inLanguage":"en-US","about":{"@id":"<?php echo home_url(1)?>#organization"},"datePublished":"<?php the_time('Y-m-d h:i:sP', 1);?>","dateModified":"<?php the_modified_time('Y-m-d h:i:sP')?>","description":"proporcionar información sobre la venta de máquinas de construcción en América del Sur, incluyendo la planta de procesamiento por lotes, la planta de asfalto, la planta de trituración, la mezcladora de hormigón, la bomba de cocer, el equipo de barras de acero, etc. ","potentialAction":[{"@type":"ReadAction","target":["<?php echo home_url(1)?>"]}]}]}</script>
<?php }elseif(is_category()){?>
    <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"<?php echo home_url(1)?>#organization","name":"Camelway América del sur","url":"<?php echo home_url(1)?>","sameAs":["https://www.camelway.com/","https://www.facebook.com/camelway/"],"logo":{"@type":"ImageObject","@id":"<?php echo home_url(1)?>#logo","inLanguage":"en-US","url":"https://data.camelway.net/static/images/camelway-500x500.png","width":500,"height":500,"caption":"Camewlay América del sur Logo"},"image":{"@id":"<?php echo home_url(1)?>#logo"}},{"@type":"WebSite","@id":"<?php echo home_url(1)?>#website","url":"<?php echo home_url(1)?>","name":"Camelway América del sur","inLanguage":"es-ES","description":"vender la maquinaria de construcción y proporcionar información sobre la maquinaria de construcción en América del sur","publisher":{"@id":"<?php echo home_url(1)?>#organization"},"potentialAction":[{"@type":"SearchAction","target":"<?php echo home_url(1)?>?s={search_term_string}","query-input":"required name=search_term_string"}]},{"@type":"CollectionPage","@id":"<?php the_category_link()?>#webpage","url":"<?php  the_category_link()?>","name":"<?php the_category_name()?>","isPartOf":{"@id":"<?php echo home_url(1)?>#website"},"inLanguage":"en-US","description":"<?php dm_description(180)?>..."}]}</script>
<?php }elseif(is_single() && in_category(array(1,2,3,4,5,6,7))) { ?>
    <script type="application/ld+json">{"@context":"https://schema.org/","@type":"Product","name":"<?php the_subtitle()?>","image":[<?php $images = get_post_images('gallery'); $tmp = '"'.get_the_thumbnail().'",';foreach($images as $image){ $tmp .= sprintf('"%s",', $image->url);} echo trim($tmp, ',')?>],"description":"<?php echo dm_trim_words(get_the_excerpt(), 200);?>","sku":"p-<?php the_ID()?>","mpn":"<?php echo the_category_slug().'-'.get_the_ID();?>","brand":{"@type":"Brand","name":"Camelway"}}}</script>
<?php }elseif(is_single() && in_category(array(8,9))){?>
    <script type="application/ld+json">{"@context": "http://schema.org","@type": "BlogPosting","headline": "<?php the_title()?>","alternativeHeadline":"<?php the_subtitle()?>","datePublished": "<?php the_time('Y-m-d');?>","dateModified": "<?php the_modified_time('Y-m-d');?>","image":[<?php $images = get_post_images('gallery'); $tmp = '"'.get_the_thumbnail().'",';foreach($images as $image){ $tmp .= sprintf('"%s",', $image->url);} echo trim($tmp, ',')?>],"keywords":[<?php echo trim(get_the_tag_list('"','"',','),',')?>],"mainEntityOfPage":"<?php the_permalink();?>","description":"<?php echo dm_trim_words(get_the_excerpt(), 160)?>","author": "<?php the_author()?>","publisher":{"@type": "Organization","name": "Camelway América del sur","url": "https://www.camelway.pe","logo": {"@type": "ImageObject","url": "https://data.camelway.net/static/images/camelway-114x114.png","width":"114","height":"114"}}}</script>
<?php } ?>
    ...
    .primary-banner .amp-carousle-subtitle {position:absolute;left:0;right:0;bottom:10px;font-size:16px;text-align:center;color:#fff}
    ...
    .feedback .result {float:left;width:calc(90% - 80px)}
    .category-entry {margin:10px 0 0 0;padding:10px 5px;background:#fff}
    ...
    .category-thumb ul {display:flex;flex-wrap:wrap;justify-content:space-between;list-style:none}
    ...
    .single-header h1.aligncenter {text-align:center;margin-bottom:5px;width:100%;}
    ...
    .single-content p a{color:#ffcc00;}
...
<header class="wrap">
    ...
    <div class="menu">
        <ul>
            <li><a href="<?php the_mobile_permalink(41)?>">Sobre nosotros</a></li>
            <li><a href="<?php the_mobile_permalink(42)?>">Contáctenos</a></li>
