...
<div class="container single single-gallery">
    <div class="main">
        ...
        <div class="pubmeta">
        <span class="author"><?php the_author();?></span> Publicado este álbum el <span class="date" pubdate="<?php the_time('Y-m-d H:i:s');?>"><?php the_time('Y-m-d');?></span>
</div>
        <div class="content">
...
?>
        ...
        <script type="application/ld+json">
        {
            ...
            "image": "<?php $imgs = get_post_images('gallery'); echo empty($imgs[1]->url) ? $imgs[0]->url : $imgs[1]->url;?>",
            "publisher": {
                "@type": "Organization",
                "name": "CAMELWAY CHINA",
                "logo": {
                    "@type": "ImageObject",
                    "url": "https://data.camelway.net/static/images/camelway-114x114.png"
                },
                "url": "https://www.camelway.pe/"
            },
            "hasPart": {
                "@type": "ImageGallery",
                "associatedMedia": {
                    "@type": "ImageObject",
                    "contenturl": "<?php the_image_link()?>",
                    "width": "10",
                    "height": "10",
                    "caption": "<?php the_image_title()?>",
                    "description": "<?php the_image_description()?>"
                }
            }
        }
        </script>
        ...
        var index = window.location.hash.match(/\d+/) ? parseInt(window.location.hash.match(/\d+/)) % images.length - 1 : 0;
